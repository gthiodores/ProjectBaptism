<?php
	...
	//function untuk membuat tabel data_kepastoran
	function createTableDataKepastoran($link){
		$link->query("CREATE TABLE data_kepastoran (
    ...
    if (!$result = $conn->query("SHOW TABLES LIKE data_kepastoran")) {
        createTableDataKepastoran($conn);
    }
